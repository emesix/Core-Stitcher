from stitch_workbench.sdk import ModuleType


def test_switchcraft_module_type():
    from stitch.switchcraft import SwitchcraftModule
...
def test_opnsensecraft_module_type():
    from stitch.opnsensecraft import OpnsensecraftModule
...
def test_proxmoxcraft_module_type():
    from stitch.proxmoxcraft import ProxmoxcraftModule
...
def test_collectkit_module_type():
    from stitch.collectkit import CollectkitModule
...
def test_verifykit_module_type():
    from stitch.verifykit import VerifykitModule
...
def test_tracekit_module_type():
    from stitch.tracekit import TracekitModule
...
def test_interfacekit_module_type():
    from stitch.interfacekit import InterfacekitModule

...
def test_load_workbench_config(tmp_project: Path):
    from stitch_workbench.config.loader import load_workbench_config
...
def test_load_workbench_config_missing_file(tmp_path: Path):
    ...
    from stitch_workbench.config.loader import ConfigLoadError, load_workbench_config
...
def test_load_module_configs(tmp_project: Path):
    from stitch_workbench.config.loader import load_module_configs
...
def test_load_module_name_mismatch(tmp_path: Path):
    ...
    from stitch_workbench.config.loader import ConfigLoadError, load_module_configs
